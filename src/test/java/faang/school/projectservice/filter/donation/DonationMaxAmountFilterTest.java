...
class DonationMaxAmountFilterTest {

    @InjectMocks
    private DonationMaxAmountFilter donationMaxAmountFilter;
    ...
    @Test
    void isApplicable() {
        Assertions.assertTrue(donationMaxAmountFilter.isApplicable(donationFilterDto));
    }
    ...
    void apply() {
        ...
        Stream<Donation> actualStream = donationMaxAmountFilter.apply(donationStream, donationFilterDto);

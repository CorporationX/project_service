...
class DonationCurrencyFilterTest {
    ...
    @Test
    void isApplicable() {
        Assertions.assertTrue(donationCurrencyFilter.isApplicable(donationFilterDto));
    }
    ...
    void apply() {
        ...
        Stream<Donation> actualStream = donationCurrencyFilter.apply(donationStream, donationFilterDto);

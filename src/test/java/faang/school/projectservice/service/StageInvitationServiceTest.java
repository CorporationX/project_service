...
public class StageInvitationServiceTest {
    ...
    private final DtoStage stage1 = new DtoStage(1L);
    private final DtoStage stage2 = new DtoStage(2L);
    private final DtoStageInvitation invitation1 = new DtoStageInvitation("hello", 1L, 1L, stage1);
    private final DtoStageInvitation invitation2 = new DtoStageInvitation("world", 1L, 1L, stage2);

    private final DtoStageInvitation invitation3 = new DtoStageInvitation("russia", 2L, 1L, stage1);

    private final DtoStageInvitation invitation4 = new DtoStageInvitation("super", 1L, 1L, stage2);

...
class DateGoogleConverterTest {
    ...
    private EventDateTime expectedTime1 = new EventDateTime()
            .setDateTime(new DateTime(new Date(105, Calendar.AUGUST, 15, 17, 30)));
    private EventDateTime expectedTime2 = new EventDateTime()
            .setDateTime(new DateTime(new Date(120, Calendar.SEPTEMBER, 1, 13, 0)));
    private EventDateTime expectedTime3 = new EventDateTime()
            .setDateTime(new DateTime(new Date(100, Calendar.DECEMBER, 31, 23, 59)));
    @Test

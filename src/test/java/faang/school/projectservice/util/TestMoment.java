...
public class TestMoment {
    ...
    public static Moment MOMENT_2 = Moment.builder().id(MOMENT_ID_2).date(NOW.minusDays(1)).build();
    public static Moment MOMENT_3 = Moment.builder().id(MOMENT_ID_3).date(NOW.plusDays(1)).build();

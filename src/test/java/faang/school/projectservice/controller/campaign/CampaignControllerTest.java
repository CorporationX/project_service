...
class CampaignControllerTest {
    ...
    class Create {
        ...
        public void successful() throws Exception {
            ...
            mockMvc.perform(post("/campaign/{projectId}/{userID}", projectId, userID)
    ...
    class Update {
        ...
        public void successful() throws Exception {
            ...
            mockMvc.perform(put("/campaign/{projectId}/{campaignId}/{updaterId}", projectId, campaignID, userID)
                            .contentType("application/json")
    ...
    class SoftDelete {
        ...
        public void successful() throws Exception {
            ...
            String expectedMessage = String.format("Campaign with %d id was soft-deleted successful", campaignID);

            mockMvc.perform(delete("/campaign/{projectId}/{campaignId}/{deleterId}", projectId, campaignID, userID))
                    .andExpect(status().isOk())
    ...
    class GetCampaign {
        ...
        public void successful() throws Exception {
            ...
            mockMvc.perform(get("/campaign/{projectId}/{campaignId}", projectId, campaignID))
                    .andExpect(status().isOk());
    ...
    class GetCampaignByFilter {
        ...
        public void successful() throws Exception {
            ...
            mockMvc.perform(post("/campaign/{projectId}", projectId)
                            .contentType("application/json")
                            .content(campaignUpdateJson))
                    .andExpect(status().isOk());
        ...
        public void notFoundException() throws Exception {
            ...
            mockMvc.perform(post("/campaign/{projectId}", projectId, campaignID)
                            .contentType("application/json")
                            .content(campaignUpdateJson))
                    .andExpect(status().isNotFound());

...
public class CampaignController {
    ...
    public CampaignDto create(
        ...
        return campaignService.createCampaign(dto, userId);
    }
    ...
    @GetMapping
    public List<CampaignDto> getWithFilters(
            @PathVariable Long projectId,
        ...
        CampaignDto filter = CampaignDto.builder()
                .projectId(projectId)
                ...
                .createdBy(createdBy)
                .build();
        return campaignService.getCampaignDtoWithFilters(filter);
    }
}

...
public class ProjectController {
    ...
    public ProjectCoverDto addProjectCover(@PathVariable Long projectId, @RequestParam("file") MultipartFile file) {
        return projectService.addProjectCover(projectId, file);
    }

    @DeleteMapping("/cover/{projectId}")
    public ProjectCoverDto deleteProjectCover(@PathVariable Long projectId) {

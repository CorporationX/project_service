...
public class CampaignController {
    ...
    @PutMapping("/{id}")
    public CampaignUpdateDto update(@PathVariable Long id, @Valid @RequestBody CampaignUpdateDto campaignUpdateDto) {
        return campaignService.update(id, campaignUpdateDto);
    }

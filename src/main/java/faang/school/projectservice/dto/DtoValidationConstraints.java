...
public final class DtoValidationConstraints {
    ...
    public static final String PROJECT_STORAGE_SIZE_UPPER_LIMIT = "Maximum storage size is 1 GB";
    public static final String PROJECT_MAX_STORAGE_SIZE_LOWER_LIMIT = "Max storage size must be greater than or equal to 0";
    public static final String PROJECT_MAX_STORAGE_SIZE_UPPER_LIMIT = "Maximum storage size is 1 GB";

...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ControllerError> handleViolationException(ValidationException ex) {
        HttpStatus httpStatus = HttpStatus.BAD_REQUEST;
        return ResponseEntity
                .status(httpStatus)
                .body(new ControllerError(httpStatus.value(), ex.getMessage()));
    ...
    @ExceptionHandler
    public ResponseEntity<ControllerError> handleSecurityException(SecurityException ex) {

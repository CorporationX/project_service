...
public class ResourceValidator {
    ...
    public void validateUserCanDownloadFromProject(Long userId, Project project) {
        boolean isProjectNotPublic = !presentationValidator.isProjectPublic(project);
        boolean isUserNotInProject = !presentationValidator.isUserParticipatedInProject(userId, project);

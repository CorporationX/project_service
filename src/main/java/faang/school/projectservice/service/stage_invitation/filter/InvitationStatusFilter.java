...
public class InvitationStatusFilter implements StageInvitationFilter {
    ...
    public Stream<StageInvitation> apply(Stream<StageInvitation> invitations, StageInvitationFilterDto filter) {
        return invitations.filter(invitation -> invitation.getStatus().equals(filter.getStatusPattern()));
    }
}

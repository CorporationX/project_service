...
import static faang.school.projectservice.exception.internship.InternshipError.ABSENT_INTERN_ROLE_EXCEPTION;
...
public class TeamMemberService {
    ...
    private void changeRole(List<TeamMember> interns) {
        interns.forEach(intern -> {
            ...
            if (roles.contains(TeamRole.INTERN) && roles.size() == 1)

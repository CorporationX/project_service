...
CREATE TABLE moment_member
(
    id        BIGSERIAL PRIMARY KEY,
    moment_id BIGINT,
    user_id   BIGINT,
    CONSTRAINT moment_project_fk FOREIGN KEY (moment_id) REFERENCES moment (id),
    CONSTRAINT team_member_fk FOREIGN KEY (user_id) REFERENCES team_member (id)
);